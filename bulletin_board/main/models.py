...
class AdvUser(AbstractUser):
    ...
    def delete(self, *args, **kwargs):
        for bboard in self.bboard_set.all():
            bboard.delete()
...
class AdditionalImage(models.Model):
    bboard = models.ForeignKey(Bboard, on_delete=models.CASCADE, verbose_name='Объявления')
...
class Comment(models.Model):
    bboard = models.ForeignKey(Bboard, on_delete=models.CASCADE, verbose_name='Объявление')
