...
from .models import Bboard, AdditionalImage
...
class NonactivationFilter(admin.SimpleListFilter):
...
class AdvUserAdmin(admin.ModelAdmin):
    ...
    list_filter = (NonactivationFilter,)
...
class CommentAdmin(admin.ModelAdmin):
    readonly_fields = ('bboard',)
    fields = ('bboard', 'author', 'content',)
